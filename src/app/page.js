...
export default function Home() {
  ...
  return (
    <main className='h-screen md:min-h-screen xl:h-screen w-screen overflow-hidden flex justify-center items-center bg-cover bg-center' style={{ backgroundImage: "url(/images/background.jpg)" }}>
