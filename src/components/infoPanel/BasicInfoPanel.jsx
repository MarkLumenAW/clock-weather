...
export default function BasicInfoPanel(props) {
  return (
    <div className='w-[360px] h-[560px] md:w-[600px] md:h-[320px] flex flex-col md:flex-row justify-between items-center py-6 md:p-6 bg-violet-950/50 backdrop-blur-md rounded-3xl border-[#757575] border shadow-2xl shadow-black/60'>
      {/* Clock */}
      <div>
